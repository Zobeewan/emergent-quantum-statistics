...
N_particles: int = 1200       # Number of independent particles
N_CORES: int = -1             # -1 = use all available cores
SUBSAMPLE: int = 1            # 1 = keep all points, 10 = keep 1/10
...
alpha: float = 4.0            # Coupling strength (Inertial factor analog k/m)
