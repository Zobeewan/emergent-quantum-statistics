...
Key physical parameters (diffusion Dψ​, coupling α, memory γ) are defined at the top of each script. The default values are tuned for the "quantum regime" convergence.    
